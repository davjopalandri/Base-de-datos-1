...
CREATE TABLE dbo.Remolques(
	ID_Remolques int NOT NULL IDENTITY PRIMARY KEY,
...
INSERT INTO dbo.Marcas (Nombre_Marca)
VALUES
    ('Scania'),
    ('Mercedez Benz'),
    ('Volkswagen');

INSERT INTO dbo.Modelos (Nombre_Modelos, ID_Marca)
VALUES
    ('Serie P', 1),
    ('Actros', 2),
    ('Constellation', 3);
...
INSERT INTO dbo.Camiones (Patente, ID_Modelo, Año, ID_Remolque)
VALUES
    ('ABC123', 1, '2020-01-01', 1),
    ('DEF456', 2, '2019-02-15', 2),
    ('GHI789', 3, '2018-05-10', 3);
...
VALUES
	...
	(3, 'Fefe', 'López', 'Transportes Rosario SA', 87654321, '27-87654321-8', 'Dirección2', '555-987-654', 'ana@email.com');
...
VALUES
	(NULL, NULL, NULL, 'McDonalds', '201215125', '555-345-678', 'carlos@email.com', 3, 'Dirección3'),
...
VALUES
    ...
    (3, 3, 5, 'Dirección Origen 3', 6, 'Dirección Destino 3', 300, '2023-11-02', '2023-11-02', '2023-11-07', '2023-11-07'),
	(4, 3, 5, 'Dirección Origen 7', 6, 'Dirección Destino 3', 800, '2023-11-02', '2023-11-02', '2023-11-07', '2023-11-07');